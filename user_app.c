...
{   
    ...
    static u16 au16NoteLength[] = {N4,N4,N4,N4,N4,N4,N2,N4,N4,N4,N4,N4,N4,N2,N8};
    
    
    static u16 u16Timer = 0x0000;
    static int Index = 0;
    
        
    if(u16Timer == au16NoteLength[Index])
    {
        while(Index<15)
        {
            Index ++; 
    ...
    {
        InterruptTimerXus(au16Notes[Index],true);
        u16Timer++;     
    }
  */
} /* end UserAppRun() */
